defmodule Cure.Stdlib.DependentRegexLanguageCorrectnessTest do
  ...
  test "recursive denotation preserves grouped child membership" do
    ...
    assert Env.total?(env, :"Std.Regex.Proof#lift_repeat_initial_active_member")
    assert Env.total?(env, :"Std.Regex.Proof#lift_repeat_filtered_active_transition_member")
    assert Env.total?(env, :"Std.Regex.Proof#lift_repeat_filtered_closing_transition_member")
    assert Env.total?(env, :"Std.Regex.Proof#lift_repeat_filtered_reentry_transition_member")
    assert Env.total?(env, :"Std.Regex.Proof#lift_repeat_closing_active_path")
